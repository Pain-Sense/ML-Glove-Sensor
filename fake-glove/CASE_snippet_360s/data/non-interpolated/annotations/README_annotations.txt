%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%           README -- CASE_dataset/data/non-interpolated/annotations
%
...
(1) General Information:
-------------------------------------------------------------------------------
This folder contains the non-interpolated annotation data for all 30 subjects.
...
PLEASE NOTE: The annotation data in this folder is non-interpolated. Please see
