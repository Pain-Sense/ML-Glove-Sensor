%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%          README -- CASE_dataset/data/non-interpolated/physiological
%
...
(1) General Information:
-------------------------------------------------------------------------------
This folder contains the non-interpolated physiological data for all 30 subjects.
...
acquired through a DAQ card and logged using LabVIEW. The logged raw data stores the acquired values in volts, that need to be converted into the desired units for each sensor (see the list above). This is done using the formulas provided by the manufacturer. Please see the data descriptor for more details on this topic.

PLEASE NOTE: The physiological data in this folder is non-interpolated. Please
