%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%						README -- CASE_dataset_snippet
%
% This short guide to a snippet of the CASE dataset, covers the following 
% topics:
% (1) Note.
...
(1) Note:
-------------------------------------------------------------------------------
This snippet of the CASE dataset only contains data from first two subjects
and is provided to allow users to browse through the data before downloading
the complete dataset.

For the sake of brevity, we have not changed all the README files in this snippet to reflect that it only contains data from 2 participants. Accordingly, in the README files users might come across sentences like, 'this folders contains data from all 30 partcipants'. Users should therefore ignore  these statements as the snippet only contains data from 2 participants.   
...
a different interpolation approach or prefer the non-interpolated data for other reasons. 
